...
<div class="grid">
    ...
    <th>Prescription<div>Prescription</div></th>
    <th>Status<div>Status</div></th>
    <th>Request Doctor<div>Request Doctor</div></th>
    </tr>
    </thead>
    <tbody>
  ...
  <tr>
    ...
    <td><a href = "/download/${element.pid}/">Reports</a></td>
    <td><a href = "/medical_request/${element.pid}/">Prescription</a></td>
    <td>${ element.status }</td>
    <td><a href = "/requestDoctor/${element.pid}/">Accept Request</a>
  </tr>
</c:forEach>
        </tbody>
    </table>
